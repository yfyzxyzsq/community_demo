...
import com.nowcoder.community.constant.ExpiredConstant;
...
public class LoginController {
    ...
    /**
     *com.nowcoder.community.controller.LoginController.getKaptcha();
     *@Description:生成验证码，保存到session，并发送到浏览器
     *@ParamType:[javax.servlet.http.HttpServletResponse, javax.servlet.http.HttpSession]
     *@ParamName:[response, session]
     *@Return:void
     *@author fyd
     *@create 2023/1/3 21:04
     *@version:
     */
...
//        session.setAttribute("kaptcha", text);
        ...
        //将验证码存入redis
        redisTemplate.opsForValue().set(RedisKeyUtil.getKaptchaKey(kaptchaOwner), text, 120, TimeUnit.SECONDS);
    ...
    public String login(String username, String password, String code, boolean rememberme,
                        Model model, HttpServletResponse response, @CookieValue("kaptchaOwner") String owner){
//        String kaptcha = (String) session.getAttribute("kaptcha");
        ...
        int expiredSeconds = rememberme ? ExpiredConstant.REMEMBER_EXPIRED_SECONDS : ExpiredConstant.DEFAULT_EXPIRED_SECONDS;
